...
/**
  ...
  *
  * KMeansClustering.scala trainingData.csv testData.csv 3 50 1000
  */
object KMeansClustering{
  ...
  def main (args: Array[String]) {
    if (args.length < 5) {
      println("KMeansClustering Usage: trainingDataFilePath testDataFilePath numClusters numIterations runTimes")
      sys.exit(1)
    }
